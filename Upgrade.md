...
3. Easy migration from **Sonoff-MQTT-OTA-Arduino 3.0.9** to **Sonoff-Tasmota 4.x**<br/>After installing Sonoff-Tasmota for the first time some settings need to be adjusted via web configuration or MQTT commands.
